package com.demoWinium.automation.utils;
...
public class Excel {
    ...
    public static String[][] excelFilter() throws IOException{
        ...
        int columnLogin = columnLogin(), columnStatus = columnStatus(), contFilter = 0;
    ...
    public static void excelDateComparison(int contRow, int contColumn, String [][] dataFilterSeparated ) throws IOException {
        int columnLastLogin = columnLastLogin(), columnComparison = contColumn+1, contCandidates = 0;
    ...
    public static void saveExcel(int contRow, String [][] dataSave) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("Resource/DataFinal.xls");
        workbook.write(out);
        out.close();
    }
}
